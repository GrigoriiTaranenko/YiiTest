...
use Yii;
use frontend\models\BookType;
use frontend\models\BookTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BooktypeController implements the CRUD actions for BookType model.
 */
class BooktypeController extends Controller
{
    ...
    {
        $searchModel = new BookTypeSearch();
